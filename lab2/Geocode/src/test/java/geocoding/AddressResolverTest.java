...
class AddressResolverTest {
    ...
    public void whenBadCoordidates_throwBadArrayindex() throws IOException, URISyntaxException, ParseException {
        when(client.get(contains("location=360.000000%2C360.000000"))).thenThrow(IndexOutOfBoundsException.class);

        assertThrows(IndexOutOfBoundsException.class, () -> resolver.findAddressForLocation(360.000000,360.000000));
    }
}